...
public class QueryResult {
	...
	public QueryResult(List<Cell[]> cellset, CellDataSet cellDataSet) {
		this(cellset, cellDataSet.getRuntime(), cellDataSet.getWidth(), cellDataSet.getHeight(),
				cellDataSet.getLeftOffset(), cellDataSet.getTopOffset(),
