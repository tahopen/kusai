...
public interface IRepositoryManager {
  ...
  List<org.kusai.database.dto.MondrianSchema> getAllSchema() throws RepositoryException;
  ...
  List<org.kusai.database.dto.MondrianSchema> getInternalFilesOfFileType(String type) throws RepositoryException;
