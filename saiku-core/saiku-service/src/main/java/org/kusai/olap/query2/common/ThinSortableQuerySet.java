package org.kusai.olap.query2.common;
...
public interface ThinSortableQuerySet extends ThinQuerySet {
     ...
     *
     * <p>
     * This capability is only available when a single Hierarchy is
     * selected on an axis
     *
     ...
     *
     * <p>
     * The Hierarchy inclusions will be wrapped in an MDX Hierarchize
     * function call.
     *
     * <p>
     * This capability is only available when a single Hierarchy is
     ...
     *                        their children. (Equivalent to the POST/PRE MDX
     *                        literal for the
