 ...
 */
package org.kusai.olap.query;

import org.kusai.olap.dto.SaikuCube;
import org.kusai.olap.dto.SaikuTag;
import org.kusai.olap.dto.filter.SaikuFilter;
import org.kusai.olap.query.QueryProperties.QueryProperty;
import org.kusai.olap.query.QueryProperties.QueryPropertyFactory;
import org.kusai.olap.util.QueryConverter;
import org.kusai.olap.util.SaikuProperties;
import org.kusai.olap.util.exception.SaikuIncompatibleException;
    ...
    public CellSet execute() throws Exception {
        try {
            ...
            if (scenario != null && query.getDimension(SCENARIO) != null) {
                ...
                Selection sel = dimension.createSelection(
    ...
    public Properties getProperties() {
        ...
        try {
            ...
            if (query.getDimension("Scenario") != null) {
                this.properties.put("org.kusai.connection.scenario", Boolean.toString(true));
            } else {
                this.properties.put("org.kusai.connection.scenario", Boolean.toString(false));
            }
            this.properties.put("org.saiku.query.explain",
                    Boolean.toString(connection.isWrapperFor(RolapConnection.class)));
        } catch (Exception e) {
            this.properties.put("org.kusai.connection.scenario", Boolean.toString(false));
