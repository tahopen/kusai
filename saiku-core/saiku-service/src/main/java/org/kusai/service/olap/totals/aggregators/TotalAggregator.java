package org.kusai.service.olap.totals.aggregators;
...
public abstract class TotalAggregator {
  ...
  public void addData(Cell cell) {
    try {
      // FIXME - maybe we should try to do fetch the format here, but seems to cause
      // some issues? infinite loop? make
