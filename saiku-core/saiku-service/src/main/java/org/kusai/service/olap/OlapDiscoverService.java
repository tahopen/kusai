...
import org.kusai.olap.discover.OlapMetaExplorer;
...
public class OlapDiscoverService implements Serializable {
  ...
  public List<SimpleCubeElement> getLevelMembers(SaikuCube cube, String hierarchyName, String levelName,
      String searchString, int searchLimit) {
    try {
  ...
  public Map<String, Object> getProperties(SaikuCube cube) {
    ...
    try {
      ...
      try {
        ...
        properties.put("org.kusai.connection.scenario", isScenario);
      } catch (Exception e) {
        properties.put("org.kusai.connection.scenario", false);
      }
    } catch (Exception e) {
      throw new SaikuServiceException(e);
    }
