...
import org.kusai.database.dto.SaikuUser;
import org.kusai.datasources.datasource.SaikuDatasource;
import org.kusai.log.LogExtractor;
import org.kusai.service.datasource.DatasourceService;
...
import org.kusai.service.util.exception.SaikuDataSourceException;
import org.kusai.service.util.exception.SaikuServiceException;
import org.kusai.web.rest.objects.DataSourceMapper;
...
public class AdminResource {
    ...
    @Path("/datasources/{id}")
    @ReturnType("org.kusai.web.rest.objects.DataSourceMapper")
    ...
    @Produces({ "application/json" })
    @Path("/users/{id}")
    @ReturnType("org.kusai.database.dto.SaikuUser")
