...
public class StatisticsResource {
	...
	// setupLog("org.kusai.service", "INFO", saikuWriter);
	...
	// Logger pkgLogger =
	// Logger.getRootLogger().getLoggerRepository().getLogger(category);
	// pkgLogger.setLevel(Level.toLevel(level));
	// WriterAppender appender = new WriterAppender(new PatternLayout("%d{ISO8601}
	// %p - %m%n"), writer);
