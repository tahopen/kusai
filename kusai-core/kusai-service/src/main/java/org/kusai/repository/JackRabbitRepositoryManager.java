...
public class JackRabbitRepositoryManager implements IRepositoryManager {
  ...
  private JackRabbitRepositoryManager(String config, String data, String password, String oldpassword,
      String defaultRole, ScopedRepo sessionRegistry, boolean workspaces) {
    this.config = config;
    this.data = data;
  ...
  /*
   * TODO this is currently threadsafe but to improve performance we should split
   * it up to allow multiple sessions to hit the repo at the same time.
   */
  public static synchronized JackRabbitRepositoryManager getJackRabbitRepositoryManager(String config, String data,
      String password, String oldpassword, String defaultRole, ScopedRepo sessionRegistry, boolean workspaces) {
    if (ref == null)
      // it's ok, we can call this constructor
      ref = new JackRabbitRepositoryManager(config, data, password, oldpassword, defaultRole, sessionRegistry,
          workspaces);
    return ref;
  }
