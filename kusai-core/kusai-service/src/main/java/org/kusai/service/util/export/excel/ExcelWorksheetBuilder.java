package org.kusai.service.util.export.excel;
...
public class ExcelWorksheetBuilder {
    ...
    private void init(CellDataSet table, List<ThinHierarchy> filters, ExcelBuilderOptions options) {
        ...
        scanRowAndColumnAggregations(table.getRowTotalsLists(), rowScanTotals, table.getColTotalsLists(),
                colScanTotals);
    }
    ...
    private void scanRowAndColumnAggregations(List<TotalNode>[] rowTotalsLists,
            Map<Integer, TotalAggregator[][]> rowScanTotals, List<TotalNode>[] colTotalsLists,
    ...
    private int setRowTotalAggregationCell(Map<Integer, TotalAggregator[][]> scanTotals, int startIndex, int subIndex,
            boolean grandTotal) {
    ...
    private int setColTotalAggregationCell(Map<Integer, TotalAggregator[][]> scanTotals, Row sheetRow, int x,
            int column, boolean setValue, boolean grandTotal) {
        column++;
     ...
     * @param tmpCellUniqueValueByColumn tmp map to compare previews value(max
     *                                   possible value = columns size)
     */
