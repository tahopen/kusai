...
var AboutModal = Modal.extend({
	...
	message:
		...
		'<li><a href="http://www.meteorite.bi/kusai-pricing" target="_blank">Order more licenses here</a></li>' +
		"</ul>" +
		"</div>" +
		'<div class="footer">' +
	...
	initialize: function (args) {
		...
		this.options.title =
			'<span class="i18n">About</span> ' + Settings.VERSION;
	...
	render_license_info: function () {
		var licenseType =
			Settings.LICENSE.licenseType === "community_edition"
				? "Open Source License"
		...
		if (Settings.LICENSE.expiration) {
			...
			this.$el
				...
				.text(expiration.toLocaleDateString());
		}
